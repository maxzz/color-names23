import namedColors from './tw-colorNames'; //https://github.com/tailwindlabs/tailwindcss/blob/master/src/util/color.js
...
export function formatColor({ mode, color, alpha }: { mode: 'rgba' | 'hsla'; color: number[]; alpha: string; }) {
