//'use client'; //https://gradientpicker.vercel.app
...
export function PickerExample() {
    ...
    return (
        <div
            className="preview flex items-center justify-center rounded !bg-cover !bg-center p-10 transition-all"
            style={{ background }}
        >
...
const GradientButton = ({ background, children, }: { background: string; children: React.ReactNode; }) => {
    return (
