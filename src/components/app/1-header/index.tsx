...
export function App1_Header({ className, ...rest }: HTMLAttributes<HTMLDivElement>) {
    return (
        <div className="mt-4 flex flex-col">
            ...
            <div className={classNames("flex-1 px-4 pt-12 bg-background flex md:block md:flex-col items-center justify-between", "border-blue-300 border-b", className)} {...rest}>
