export function Header() {
    return (<>
        ...
        <div className="mb-1 text-xs text-muted-foreground border-border border-b pl-2">Foreground</div>
    </>);
}
...
export function Header2() {
    return (<>
        ...
        <div className="mb-1 text-xs text-muted-foreground border-border border-b mt-4 pl-2"></div>
    </>);
}
